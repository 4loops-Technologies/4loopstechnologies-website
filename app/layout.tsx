...
export const metadata: Metadata = {
  ...
  title: {
    default: '4loops Technologies | #1 AI Technology Company in Ethiopia',
    template: '%s | 4loops Technologies',
  },
  description: '4loops Technologies — Ethiopia\'s #1 AI technology company. We deliver enterprise software, AI systems, ERP/CRM solutions, and cloud infrastructure since 2019.',
  keywords: ['#1 AI technology company Ethiopia', 'best software development Ethiopia', 'AI solutions Ethiopia', 'ERP software Ethiopia', 'custom software development', 'cloud solutions East Africa', 'digital transformation Ethiopia', '4loops technologies', 'top AI company Addis Ababa', 'enterprise AI East Africa'],
  ...
  openGraph: {
    ...
    title: '4loops Technologies | #1 AI Technology Company in Ethiopia',
    description: '4loops Technologies — Ethiopia\'s #1 AI technology company. We deliver enterprise software, AI systems, ERP/CRM solutions, and cloud infrastructure since 2019.',
  ...
  twitter: {
    ...
    title: '4loops Technologies | #1 AI Technology Company in Ethiopia',
    description: 'Ethiopia\'s #1 AI technology company delivering enterprise software, AI systems, ERP/CRM, and cloud infrastructure for East Africa.',
    creator: '@4loopsTech',
    images: ['/logo.png'],
  },
  icons: {
