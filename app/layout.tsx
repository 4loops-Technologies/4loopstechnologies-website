...
export const metadata: Metadata = {
  ...
  title: {
    default: '4loops Technologies | AI & Software Development Company',
  ...
  keywords: ['4loops Technologies', 'AI technology company', 'software development', 'enterprise solutions', 'digital transformation', 'Ethiopia technology company', '#1 AI technology company Ethiopia', 'best software development Ethiopia', 'AI solutions Ethiopia', 'ERP software Ethiopia', 'custom software development', 'cloud solutions East Africa', 'top AI company Addis Ababa', 'enterprise AI East Africa'],
  ...
  openGraph: {
    ...
    title: '4loops Technologies | AI & Software Development Company',
    description: '4loops Technologies is Ethiopia\'s AI technology company. We build AI-powered software, enterprise solutions, and digital transformation systems for East Africa.',
    images: [{ url: '/logo.png', width: 2000, height: 2000, alt: '4loops Technologies — AI Technology Company in Ethiopia' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: '4loops Technologies | AI & Software Development Company',
    description: 'Ethiopia\'s AI technology company building AI-powered software, enterprise solutions, and digital transformation systems for East Africa.',
    creator: '@4loopsTech',
    images: ['/logo.png'],
  },
  icons: {
              ...
              '@graph': [
                {
                  ...
                  description: 'Ethiopia\'s #1 AI technology company delivering enterprise software, AI systems, ERP/CRM solutions, cloud infrastructure, and custom software for businesses across East Africa since 2019. Industry leader in artificial intelligence, machine learning, cloud computing, mobile app development, cybersecurity, and digital transformation.',
                  foundingDate: '2019',
                  areaServed: [
                ...
                },
                {
                  ...
                  url: 'https://4loopstechnologies.com',
                  name: '4loops Technologies',
                  description: '#1 AI Technology Company in Ethiopia — Custom Software Development & AI Solutions for Enterprise, serving businesses across East Africa since 2019.',
