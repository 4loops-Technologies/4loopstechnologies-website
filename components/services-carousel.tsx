...
export function ServicesCarousel() {
  ...
  const getCardStyles = (position: string) => {
    switch (position) {
      case "center":
        return { scale: 1.15, opacity: 1, filter: "blur(0px)", zIndex: 50, x: 0 }
      case "right":
        return { scale: 0.75, opacity: 0.35, filter: "blur(6px)", zIndex: 30, x: 320 }
      case "left":
        return { scale: 0.75, opacity: 0.35, filter: "blur(6px)", zIndex: 30, x: -320 }
      default:
        return {}
          ...
          return (
            ...
            >
              <motion.div
                ...
                whileHover={{
                  boxShadow: position === "center" ? "0 20px 60px rgba(0, 212, 255, 0.3)" : "none",
                }}
              >
                {position === "center" && (
                  <motion.div
